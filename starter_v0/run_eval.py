...
def main() -> None:
    ...
    for case in cases:
        ...
        try:
            # deepseek-flash thinking mode rejects tool_choice="required"; "auto" is compatible
            # and still lets the model choose tools (preflight uses None/auto successfully).
